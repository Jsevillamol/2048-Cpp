...
2. Board's size change option, between the dimensions 4, 5, 6, 8.
3. Goal's change option, between 16, and 65536.
4. Record's show option, depending the goal and size, from the main menu.
